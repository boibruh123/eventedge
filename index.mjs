...
export default async function handler(req, res) {
  ...
  if (route === "report.csv") {
    ...
    res.setHeader("content-disposition", "attachment; filename=gainesville-event-demand-report.csv");
    return res.send(csvReport(dashboard.events));
  }
  if (route === "report.pdf") {
    ...
    res.setHeader("content-disposition", "attachment; filename=gainesville-event-demand-report.pdf");
    return res.send(simplePdf("Gainesville Event Demand Report", lines));
  }
